...
public class MustHaveImplicitReq extends GearRequirement {

    public MustHaveImplicitReq(String id) {
        super(ItemReqSers.HAS_IMPLICIT, id);
    }

    @Override
    public Class<?> getClassForSerialization() {
        return MustHaveImplicitReq.class;
    }
    ...
    public TranslationBuilder createTranslationBuilder() {
        return TranslationBuilder.of(SlashRef.MODID)
                .desc(ExileTranslation.registry(this, "Must have implicit")
                );
    }
    ...
    public boolean isGearValid(ItemStack stack) {
        ...
        return gear.imp != null && gear.imp.has();
    }
}
